...
{
    public class ChillxExtractor : Extractor
    {
        public override string Name => "Chillx";
        public override string MainUrl => "chillx.to";

        private readonly HttpClientService _http;
        private readonly AngleSharpHtmlParser _parser;
        private readonly ILogger<ChillxExtractor> _logger;

        public ChillxExtractor(HttpClientService http, AngleSharpHtmlParser parser, ILogger<ChillxExtractor> logger)
        {
            _http = http;
            _parser = parser;
            _logger = logger;
        ...
        {
            _logger.LogInformation("[Chillx] Extracting {Link}", link);
            ...
            throw new System.Exception("Chillx: no source found");
        }
    }
}
